...
const US_CountryMapCard = (props) => {
    ...
    return (
        // <Jumbotron>
            <svg className="actualMap" xmlns="http://www.w3.org/2000/svg" width="auto" viewBox="0 0 972 600" preserveAspectRatio="xMidYMid meet">
