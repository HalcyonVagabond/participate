...
const US_CountryMapCard = (props) => {
    ...
    const consoleLogEvent= (event) => {
        const stateID = event.target.id
            ...
            changeCurrentState(stateID)
            const converted = convertRegion.convertForRoute(stateID, 'toName')
    ...
    return (
        // <Jumbotron>
            ...
            {/* <svg xmlns="http://www.w3.org/2000/svg" width="959" height="593"> */}
                ...
                <path id="frames" fill="none" stroke="#A9A9A9" strokeWidth="2" d="M215,493v55l36,45 M0,425h147l68,68h85l54,54v46 M560,593v-78H682V593 M635,515V593 M560,556H682 M598,556V593" />
            </svg>
        // </Jumbotron>
    );
...
export default US_CountryMapCard;